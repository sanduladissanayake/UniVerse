  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {activeTab === 'admins' && (
        <div>
          <div className="mb-6 flex justify-between items-center">
            <h2 className="text-2xl font-semibold text-gray-900">Club Admins</h2>
            <button
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              ...
              <form onSubmit={handleCreateAdmin} className="space-y-4">
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">Assign to Club (Optional)</option>
                  {clubs.map((club) => (
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Assigned Club</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {clubAdmins.map((admin) => {
                  const assignedClub = clubs.find((c) => c.adminId === admin.id);
                  return (
                    <tr key={admin.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-gray-600">{assignedClub ? assignedClub.name : 'Not assigned'}</td>
            ...
            {clubAdmins.length === 0 && (
              <div className="text-center py-8 text-gray-600">No club admins yet</div>
            )}
          </div>
        </div>
      )}
